  ...
  if (!user) {
    return (
      <div className="p-20 text-center" style={{ fontFamily: "'Sora', sans-serif" }}>
          ...
          <p className="text-slate-500 max-w-sm mx-auto font-medium">We could not retrieve your staff profile. Please try re-authenticating.</p>
          <div className="mt-8">
              <a href="/dashboard/staff" className="text-emerald-600 font-bold text-sm uppercase tracking-widest hover:underline">Return to Workspace</a>
          </div>
      </div>
    );
  }
